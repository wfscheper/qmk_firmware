# The Quotidian Layout, a modified, familiar, and powerful layout #

The Quotdian Layout is a modified version of Nicholas Keene's Oridinary layout,
that adds the Escape key to the Left Symbol shift and swaps the CMD and Alt
modifier keys to make the layout more linux and windows friendly.
